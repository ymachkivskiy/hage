...
public class SimpleConfigurationSplitterTest {
    ...
    public void shouldDivideConfigurationIntoComplementaryParts() throws Exception {
        ...
        PopulationDistributionMap originalDistributionMap = distributionFromMap(
            of(
                definedBy(1, 2, 3), populationFromPair(createAgentDefinition(), 100),
                definedBy(0, 2, 3), populationFromPair(createAgentDefinition(), 10),
                definedBy(1, 0, 3), populationFromPair(createAgentDefinition(), 122),
        ...
        assertThat(firstMap.merge(secondMap)).isEqualTo(originalDistributionMap);
    ...
    public void shouldDivideBigConfigurationIntoComplementaryParts() throws Exception {
        ...
        final PopulationDistributionMap expectedDistributionMap = distributionFromMap(range(1, populationDistributionMapSize)
            .mapToObj(i -> definedBy(r.nextInt(40000), r.nextInt(154001), r.nextInt(121002)))
            .collect(toMap(
                x -> x,
                x -> populationFromPair(createAgentDefinition(), r.nextInt(1000) + 1)
            )));
        ...
        assertThat(actualMergedMap).isEqualTo(expectedDistributionMap);
    ...
    public void shouldSaveAtomicityOfInternalPositionPopulationDescriptionDuringSplitting() throws Exception {
        ...
        Set<InternalPosition> internalPositions = range(1, internalElementsCount)
            .mapToObj(i -> definedBy(r.nextInt(12000), r.nextInt(30192), r.nextInt(324221)))
            .collect(toSet());
        ...
        final PopulationDistributionMap distributionMap = distributionFromMap(dMap);
        ...
        for (InternalPosition internalPosition : internalPositions) {
            ...
            for (Countable c : countable) {
                ...
                if (mapForCountable.getInternalPositions().contains(internalPosition)) {
                    ...
                    assertThat(actualCellPopulation).isSameAs(dMap.get(internalPosition));
                }
            }
    ...
    public void shouldDivideConfigurationIntoTwoPartsOfEqualNumberOfAgents() throws Exception {
        ...
        PopulationDistributionMap originalDistributionMap = distributionFromMap(
            ImmutableMap.<InternalPosition, CellPopulationDescription>builder()
                ...
                .put(
                    definedBy(1, 0, 42),
                    populationFromPair(createAgentDefinition(), 1)
                )
                .put(
                    definedBy(0, 2, 3),
                ...
                .put(
                    definedBy(1, 0, 3),
                    populationFromPair(createAgentDefinition(), 2)
                )
                .put(
                    definedBy(4, 2, 3),
                    populationFromPair(createAgentDefinition(), 2)
