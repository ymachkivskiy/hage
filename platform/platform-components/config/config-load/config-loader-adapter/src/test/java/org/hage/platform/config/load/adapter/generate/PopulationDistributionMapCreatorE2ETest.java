...
import org.hage.platform.config.load.adapter.PlatformConfigLoaderAdapterModuleConfiguration;
import org.hage.platform.config.load.adapter.util.ChunkPositionsConditions;
...
@ContextConfiguration(classes = PlatformConfigLoaderAdapterModuleConfiguration.class)
public class PopulationDistributionMapCreatorE2ETest {

    @Autowired
    private PopulationDistributionMapCreator tested;
