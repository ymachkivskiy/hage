...
public class ComputationConfigurationGeneratorTest {

    @InjectMocks
    private ComputationConfigurationGenerator tested;
    @Mock
    ...
    public void shouldTranslateToConfigurationWithSameGlobalComponents() throws Exception {
        ...
        ComputationConfiguration translatedConfiguration = tested.generate(configuration);
    ...
    public void shouldTranslateToConfigurationWithPopulationDistributionMergedFromAllPopulationDistributionQualifiers() throws Exception {
        ...
        ComputationConfiguration translatedConf = tested.generate(configuration);
