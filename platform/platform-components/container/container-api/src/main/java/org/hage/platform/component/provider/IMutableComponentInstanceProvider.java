...
package org.hage.platform.component.provider;
...
public interface IMutableComponentInstanceProvider extends IComponentInstanceProvider {
     ...
     *
     * @param compDefinition a component definition which describes the component to be registered
     */
     ...
     *
     * @param compImplementation a type (class) of component - the given type cannot describe an interface or an abstract class
     */
     ...
     *
     * @param key      a string key for the component
     * @param compType a type of component - the given type cannot describe an interface or an abstract class
     */
     ...
     *
     * @param compInstance a component instance to be registered
     */
