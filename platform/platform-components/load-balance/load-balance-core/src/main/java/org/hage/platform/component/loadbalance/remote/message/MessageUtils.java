...
public class MessageUtils {
    ...
    public static LoadBalancerRemoteMessage respondWithStatsMsg(NodeDynamicStats nodeDynamicStats) {
        return new LoadBalancerRemoteMessage(ACK, new LoadBalanceData(nodeDynamicStats, emptyList()));
    }
