...
import org.hage.platform.component.execution.action.ActionPhase;
import org.hage.platform.component.execution.action.AgentAction;
...
import org.hage.platform.component.execution.agent.AggregateActionService;
...
public class HelperTestAggregateActionService extends AggregateActionService {
    ...
    /**
     * This is our version of {@link org.hage.agent.AbstractAggregate}'s processEvent method, that instead of logging
