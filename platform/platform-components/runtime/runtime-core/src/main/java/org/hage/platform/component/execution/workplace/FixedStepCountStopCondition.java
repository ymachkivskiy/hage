...
import org.hage.platform.component.execution.query.CollectionQuery;
import org.hage.platform.component.execution.query.ValueFilters;
...
{ //TODO : re-implement and extract some base class with event posting etc.
    ...
    private boolean shouldStop() {
        ...
        final Collection<Long> results = query.matching("step", ValueFilters.lessThan(stepCount))
                .select(ValueSelectors.field("step")).execute(workplaceManager.getLocalWorkplaces());
