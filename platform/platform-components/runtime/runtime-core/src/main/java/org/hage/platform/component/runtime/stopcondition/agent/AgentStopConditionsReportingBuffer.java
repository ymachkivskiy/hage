...
import org.hage.platform.component.runtime.stopcondition.StopCondition;
...
@SingletonComponent
@Slf4j
class AgentStopConditionsReportingBuffer implements StopCondition, AgentStopConditionReporter {
