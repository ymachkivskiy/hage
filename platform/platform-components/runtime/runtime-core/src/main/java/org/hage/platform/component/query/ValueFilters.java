...
public final class ValueFilters {
     ...
     *
     * @param pattern A regular expression to test, cannot be <code>null</code>.
     ...
     *
     * @param value A value for equality test.
     * @param <T>   A type of the value to compare.
     * @return A new value filter.
     */
     ...
     *
     * @param value A value to compare against, not <code>null</code>.
     * @param <T>   A type of the value to compare.
     * @return A new value filter.
     */
     ...
     * @param <T>     A generic type of used filters.
     * @return A new value filter.
     */
     ...
     *
     * @param klass A type of tested objects.
     * @param <T>   A generic type of the used class.
     * @return A new value filter.
     */
     ...
     *
     * @param keyFilter   A filter to use against the key.
     * @param valueFilter A filter to use against the value.
     * @param <V>         A type of values.
     * @param <K>         A type of keys.
     * @return A new value filter.
     */
     ...
     *
     * @param filter A filter to use.
     * @param <V>    A type of property value.
     * @return A new value filter.
     */
    ...
    /**
     * Creates a filter that tests a provided filter against a {@link IAgent} friendly name.
     *
     * @param filter A filter to use.
     * @return A new value filter.
     */
    public static IValueFilter<IAgent> address(final IValueFilter<String> filter) {
        return new IValueFilter<IAgent>() {

            @Override
            public boolean matches(IAgent obj) {
                return filter.matches(obj.getAddress().getFriendlyName());
            }
        };
    }
}
