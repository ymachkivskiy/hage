...
public class DecreasingPriorityQueue {
     ...
     * Constructor.
     *
     * @param priorityDecrease value to decrease priority of the entries
     * @param priorityLimit    the minimum value of priority for the entries
     */
     ...
     * @throws NoSuchElementException occurs when the queue is empty
     */
    ...
    protected class Entry {
         ...
         *
         * @param decrease value to decrease the priority
         */
         ...
         *
         * @param nextEntry the next entry in the priority queue
         */
