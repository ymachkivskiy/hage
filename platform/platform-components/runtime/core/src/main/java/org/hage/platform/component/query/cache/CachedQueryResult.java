...
package org.hage.platform.component.query.cache;
 ...
 * transparent way.
 *
 * @param <R> A type of results stored in this container.
 * @author AGH AgE Team
 */
public class CachedQueryResult<R> {
     ...
     *
     * @param refresh True, if a refresh should be forced.
     */
     ...
     *
     * @param lastRefresh The time of the last refresh.
     */
