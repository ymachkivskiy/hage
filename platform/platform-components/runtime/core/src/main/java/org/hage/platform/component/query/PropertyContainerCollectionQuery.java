 ...
 *
 * @param <E> A type of elements in the collection. T must be a realisation of {@link IPropertyContainer}.
...
public class PropertyContainerCollectionQuery<E extends IPropertyContainer, T> extends CollectionQuery<E, T> {
     ...
     *
     * @param propertyName A name of the property that will be used in filtering.
     * @param filter       A value filter to add.
     * @param <S>          A type of a value of the tested property.
     * @return This query.
     */
    @Override
