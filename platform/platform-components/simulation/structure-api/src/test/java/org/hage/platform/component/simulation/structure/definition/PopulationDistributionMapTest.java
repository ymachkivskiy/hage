...
import static org.hage.platform.component.simulation.structure.definition.CellPopulationDescription.populationFromMap;
import static org.hage.platform.component.simulation.structure.definition.CellPopulationDescription.populationFromPair;
import static org.hage.platform.component.simulation.structure.definition.InternalPosition.definedBy;
import static org.hage.platform.component.simulation.structure.definition.PopulationDistributionMap.emptyDistributionMap;
        ...
        final PopulationDistributionMap distributionMap = PopulationDistributionMap.distributionFromMap(
            of(
                definedBy(0, 0, 1), populationFromMap(of(
                    mock(Agent.class), count1,
                    mock(Agent.class), count2
                )),
                definedBy(0, 1, 0), populationFromMap(of(
                    mock(Agent.class), count3,
                    mock(Agent.class), count4
                )),
                definedBy(1, 0, 1), populationFromPair(mock(Agent.class), count5),
                definedBy(1, 1, 0), populationFromMap(of(
                    mock(Agent.class), count6,
                    mock(Agent.class), count7,
                    mock(Agent.class), count8
                ))
            )
        );
