...
public interface IPropertiesSet extends Iterable<Property> {
     ...
     * from the set.
     */
    MetaPropertiesSet getMetaPropertiesSet();

    /**
     * Adds new property to the set.
     */
    void addProperty(Property property) throws DuplicatePropertyNameException;
     ...
     * @return
     */
    IPropertiesSet clonePropertyValues();
     ...
     */
    IPropertiesSet getSimplePropertiesSet();
}
