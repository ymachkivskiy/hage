...
public interface IPropertiesReader {
    ...
    Set<FieldMetaProperty> readFieldMetaProperties(Class<?> clazz) throws PropertyException;

    Set<GetterSetterMetaProperty> readGetterSetterMetaProperties(Class<?> clazz) throws PropertyException;
}
