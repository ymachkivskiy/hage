...
import org.hage.property.testHelpers.InnerClassWithProperties;
...
import org.hage.property.xml.testHelpers.SubExampleComponent;
...
public class XMLBasedPropertyContainerTest {
    ...
    public void testChangesNotification() throws Exception {
        ...
        monitorMock.objectChanged(container, new ObjectChangedEvent(container));
