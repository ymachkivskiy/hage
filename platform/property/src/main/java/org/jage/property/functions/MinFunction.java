 ...
 *
 */
public class MinFunction extends NumericFunction {
	 ...
	 */
	public MinFunction(String functionName, String argumentsPattern, double defaultValue) {
		super(functionName, argumentsPattern);
		_defaultValue = new Double(defaultValue);
	}
	
	/**
	 * Computes function's value. It returns the lowest argument, or default value,
