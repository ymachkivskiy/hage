...
public class XMLBasedPropertyProvider {
     ...
     *
     * @param clazz the clazz, for which MetaPropertiesSet is required
     * @return the MetaPropertiesSet for class clazz
     * @throws PropertyException the configuration exception
     */
     ...
     *
     * @param clazz the class to be adapted
     ...
     *
     * @param clazz the clazz, for which the MetaProperiesSet is created
