...
class StepProcessorsAspect {
    ...
    @Before("org.hage.platform.component.execution.aspect.Pointcuts.stepPerforming()")
    ...
    @AfterReturning("org.hage.platform.component.execution.aspect.Pointcuts.stepPerforming()")
