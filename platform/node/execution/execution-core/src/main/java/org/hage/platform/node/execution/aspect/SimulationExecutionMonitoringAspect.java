...
import org.hage.platform.node.execution.step.ExecutionStepInfoProvider;
...
class SimulationExecutionMonitoringAspect implements SimulationExecutionMonitor {
    ...
    @Before("org.hage.platform.node.execution.aspect.Pointcuts.stepPerforming()")
    ...
    @After("org.hage.platform.node.execution.aspect.Pointcuts.stepPerforming()")
