package org.hage.platform.node.rate;

import lombok.extern.slf4j.Slf4j;
import org.hage.platform.annotation.di.SingletonComponent;
import org.hage.platform.node.rate.cluster.PerformanceRate;
import org.hage.platform.node.rate.config.RatingSettingsResolver;
...
import org.hage.platform.node.rate.config.data.RatingSettings;
...
import static org.hage.platform.node.rate.cluster.PerformanceRate.sum;
