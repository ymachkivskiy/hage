...
public class ResourceLoader {
     ...
     *
     * @param uri A correct URI (not <code>null</code> nor empty string).
     * @return A resource equivalent of the URI.
     * @throws IncorrectUriException if the URI could not be parsed or the scheme was not recognised.
     */
