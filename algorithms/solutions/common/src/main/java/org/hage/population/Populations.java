...
public class Populations {
     ...
     * @param <S>      the type of solution
     * @param <E>      the type of evaluation
     * @param solution the sole solution to be stored in the returned population.
     ...
     * @param <E>        the type of evaluation
     * @param solution   the sole solution to be stored in the returned population.
     * @param evaluation the sole solution's evaluation
     * @return an immutable population containing only the specified solution.
     */
     ...
     * @param <S> the type of solution
     * @param <E> the type of evaluation
     * @param map a mapping between solutions, that the population should contain, and their evaluations
     ...
     * @param <S>       the type of solution
     * @param <E>       the type of evaluation
     * @param solutions the solutions that the population should contain, in order
