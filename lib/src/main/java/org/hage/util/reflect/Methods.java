...
public final class Methods {
    ...
    public static boolean isBooleanGetter(final Method method) {
        return method.getName().startsWith("is") && method.getName().length() > 2
                && method.getParameterTypes().length == 0 && Classes.isAssignable(method.getReturnType(), Boolean.class);
    }
    ...
    public static boolean isGetter(final Method method) {
        ...
        return method.getName().startsWith("get") && method.getName().length() > 3
                && method.getParameterTypes().length == 0 && !Classes.isAssignable(method.getReturnType(), Void.class);
    }
