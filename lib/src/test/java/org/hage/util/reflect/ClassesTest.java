package org.hage.util.reflect;


import com.google.common.base.Optional;
import com.google.common.collect.Iterables;
import org.hage.util.reflect.Classes;
...
import static org.hage.util.reflect.Classes.*;
...
public class ClassesTest {
    ...
    public void testSimilarIterablesAssignable() {
        // given
        final List<Class<?>> source = Arrays.asList(int.class, String.class, Object.class);
        final List<Class<?>> target = Arrays.asList(Number.class, Object.class, Object.class);

        // then
        assertTrue(isAssignable(source, target));
    }

    @Test
    public void testAsimilarIterablesNotAssignable() {
        // given
        final List<Class<?>> source = Arrays.asList(Number.class, String.class, Object.class);
        final List<Class<?>> target = Arrays.asList(int.class, Object.class, Object.class);

        // then
        assertFalse(isAssignable(source, target));
    }
    ...
    public void testDifferentLengthsIterablesNotAssignable() {
        // given
        final List<Class<?>> source = Arrays.asList(int.class, String.class, Object.class);
        final List<Class<?>> target = Arrays.asList(Number.class, Object.class);
