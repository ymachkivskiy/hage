 ...
 */
package org.hage.monitoring.visualization.storage;


import org.hage.monitoring.MonitoringException;
import org.hage.monitoring.visualization.storage.element.Base;
import org.hage.monitoring.visualization.storage.element.ComputationInstance;
import org.hage.monitoring.visualization.storage.element.ComputationType;
import org.hage.monitoring.visualization.storage.element.DescriptionElement;
import org.hage.monitoring.visualization.storage.element.TypeElement;
import org.hage.monitoring.visualization.storage.element.VisualDataStorage;
import org.hage.monitoring.visualization.storage.mongodb.StorageLoaderMongo;
import org.hage.monitoring.visualization.storage.mongodb.VisualDataStorageMongo;
...
public class VisualDataStorageFactory {
    ...
    public static Collection<ComputationInstance> getComputationInstanceCollection(StorageDescription storageDescription) {
        ...
        ComputationType computationType = base.get(queries.get(0));
     ...
     * @return Created VisualDataStorage instance.
     */
