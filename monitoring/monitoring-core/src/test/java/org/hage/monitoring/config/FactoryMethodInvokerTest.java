...
public class FactoryMethodInvokerTest {
    ...
    public void shouldInvokeFactoryMethod() {
        ...
        // when
        factoryMethodInvoker.invokeFactoryMethod(Collections.<Observable<Timestamped<Object>>> emptyList(), "someName", "org.hage.monitoring.config.ClassWithMethodToInvoke", "methodToInvoke");
    ...
    public void shouldNotFindClass() {
        factoryMethodInvoker.invokeFactoryMethod(Collections.<Observable<Timestamped<Object>>> emptyList(), "someName", "org.hage.monitoring.config.ClassWithMethodToInvoke", "methodWhichDoesntExist");
    }

    @Test(expected = MonitoringException.class)
    public void shouldNotFindMethod() {
        // when
        factoryMethodInvoker.invokeFactoryMethod(Collections.<Observable<Timestamped<Object>>> emptyList(), "someName", "org.hage.monitoring.config.ClassWhichDoesntExist", "methodToInvoke");
    }
