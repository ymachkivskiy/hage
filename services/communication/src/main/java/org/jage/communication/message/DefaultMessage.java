 ...
 */
@Immutable
public class DefaultMessage<A extends Address, T extends Serializable> implements Message<A, T> {
	 ...
	 */
	public DefaultMessage(final Header<A> header, @Nullable final T payload) {
	 ...
	 * 		A header that contains metadata for this message.
	 */
	public DefaultMessage(final Header<A> header) {
		this(header, null);
	}
	 ...
	 */
	public static <V extends Address, Z extends Serializable> DefaultMessage<V, Z> create(final Header<V> header,
