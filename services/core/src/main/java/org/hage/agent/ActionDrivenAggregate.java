...
/**
 * This aggregate implementation relies on a {@link org.hage.action.preparers.IActionPreparer} to provide its actual behavior.
 * <p>
 * Given the aggregate state and environment, the {@link org.hage.action.preparers.IActionPreparer} prepares an appropriate action, which is
