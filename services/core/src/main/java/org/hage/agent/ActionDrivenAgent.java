...
/**
 * This agent implementation relies on a {@link org.hage.action.preparers.IActionPreparer} to provide its actual behavior.
 * <p>
 * <p>
 * Given the agent's state and environment, the {@link org.hage.action.preparers.IActionPreparer} prepares an appropriate action, which is then
 * run by the agent.
 *
 * @author AGH AgE Team
 */
