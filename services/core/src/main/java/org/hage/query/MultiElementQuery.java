 ...
 *
 * @param <E> A type of elements in the target collection.
...
public class MultiElementQuery<E, Q, R> implements IQuery<Q, R> {
     ...
     *
     * @param target A target to convert.
     ...
     *
     * @param rawResults Raw results to convert.
     * @return Results packed into the proper type.
     * @throws QueryException when it is not possible to create the results object.
     */
    @SuppressWarnings("unchecked")
