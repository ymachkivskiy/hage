...
import org.hage.action.ActionException;
...
/**
 * The comparator that is used by the {@link org.hage.agent.SimpleAggregate} to compare actions priorities.
 * <p>
...
public class ActionComparator implements Comparator<Action> {
     ...
     *
     * @param c1       the left side of the relation.
     * @param c2       the right side of the relation.
     ...
     *
     * @param contexts context types to add.
     */
     ...
     *
     * @param contexts a list of context types to add.
