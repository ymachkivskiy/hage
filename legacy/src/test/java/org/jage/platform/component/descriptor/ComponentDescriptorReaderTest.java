...
//		final IComponentDescriptor descriptor = reader.readDescritptor(ComponentWithConstructorsOnly.class);
//		assertNotNull(descriptor);
//
//		assertTrue(descriptor.getComponentType().equals(ComponentWithConstructorsOnly.class));
//
//		// constructors
//		final Set<List<Class<?>>> expectedConstructors = new HashSet<List<Class<?>>>();
...
//		expectedConstructors.add(tempList);
//
//		final List<List<Class<?>>> constructors = descriptor.getConstructorParametersTypes();
//		final Set<List<Class<?>>> descriptorConstructors = new HashSet<List<Class<?>>>(constructors);
//
...
//		final IComponentDescriptor descriptor = reader.readDescritptor(EmptyComponent.class);
//		assertNotNull(descriptor);
//
...
//		// constructors
//		final Set<List<Class<?>>> expectedConstructors = new HashSet<List<Class<?>>>();
//		final List<Class<?>> tempList = new LinkedList<Class<?>>();
//		expectedConstructors.add(tempList);
//
//		final List<List<Class<?>>> constructors = descriptor.getConstructorParametersTypes();
//		final Set<List<Class<?>>> descriptorConstructors = new HashSet<List<Class<?>>>(constructors);
...
//		final IComponentDescriptor descriptor = reader.readDescritptor(EmptyComponent2.class);
//		assertNotNull(descriptor);
//
