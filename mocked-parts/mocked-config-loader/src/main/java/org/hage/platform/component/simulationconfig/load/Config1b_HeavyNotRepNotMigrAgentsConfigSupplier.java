...
public class Config1b_HeavyNotRepNotMigrAgentsConfigSupplier implements ConfigurationSupplier {
    ...
    public InputConfiguration getConfiguration() {
        ...
        return InputConfiguration.builder()
            ...
            .simulationDefinition(new SimulationOrganizationDefinition(
                ...
                singletonList(new AgentDefinition(HeavyNotReproducibleNotMigratingAgent.class)),
                null,
                singletonList(
                    new ChunkPopulationQualifier(
                        new Chunk(Position.position(0, 0, 0), gridDims),
                        singletonList(
                            new ChunkAgentDistribution(new AgentDefinition(HeavyNotReproducibleNotMigratingAgent.class),
                                fixed(50),
                                allPositions()
                            )
                        )
